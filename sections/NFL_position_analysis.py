...
fig1.add_trace(go.Bar(x=df['position'],
                y=df['completions'],
                name='# completions',
...
fig11.add_trace(go.Bar(x=df['position'],
                y=df['attempts'],
                name='# attempts',
                marker_color='rgb(163, 203, 249)'
                , yaxis='y'))
...
fig2.add_trace(go.Line(x=df['position'],
                y=df['interceptions'],
                name='# interceptions',
                marker_color='rgb(163, 203, 249)'
                , yaxis='y'))
...
with col1:
    ...
    .mark_line()
    .encode(x='position:N', y='interceptions:Q',color='position')
    .properties(title='Completed interceptions by position'))

col2.altair_chart(alt.Chart(df)
    .mark_line()
    .encode(x='position:N', y='receptions:Q',color='position')
    .properties(title='Completed receptions by position'))
