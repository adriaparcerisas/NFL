...
st.markdown('The intention of this analysis is to provide information about how each NFL team evolved over this current season considering metrics such as:') 
...
st.write('The first part of this app analyzes the team analysis of the NFL over the current season.')
